...
<img align="right" src="https://raw.githubusercontent.com/matiassingers/emoji-github/master/assets/pray.gif" width="120" />
...
identidade:
  ...
  periodo: "2º semestre"
  foco: ["Python", "Backend", "Django", "Bancos de Dados"]

sobre: >
 Sou estudante de Engenharia de Software na PUC-Campinas, com foco em desenvolvimento Python e banco de dados relacional (MySQL). Tenho experiência prática em projetos acadêmicos que envolvem sistemas completos de ponta a ponta: modelagem de dados, lógica de negócio, integração com banco de dados, implementação de criptografia e testes de software com unittest.
Me identifico com empresas que valorizam atenção aos detalhes e qualidade de entrega, características que procuro aplicar no meu código, desde a arquitetura do sistema até a documentação. Tenho facilidade para trabalhar em equipe,  já participei de projetos colaborativos com controle de versão via Git e me preocupo em entender o sistema como um todo e solucionar o problema.
Estou buscando estágio para contribuir com uma equipe experiente, aplicar o que aprendi em um ambiente profissional real e continuar crescendo como desenvolvedor.

modo_atual: "[ESTUDANDO] -> [CONSTRUINDO] -> [APLICANDO PARA ESTÁGIO]"
```
...
<div align="center">
<img src="https://skillicons.dev/icons?i=python,django,mysql,git,github,vscode,linux,html,css,figma&theme=dark" />
</div>
...
<!-- ===================== FERRAMENTAS ===================== -->
## `03.` FERRAMENTAS_&_PRÁTICAS

<table align="center">
<tr>
<td align="center" width="200">🧪<br/><b>unittest</b><br/><sub>testes automatizados</sub></td>
<td align="center" width="200">🔐<br/><b>Hill Cipher</b><br/><sub>criptografia aplicada</sub></td>
<td align="center" width="200">🗄️<br/><b>MySQL</b><br/><sub>modelagem de dados</sub></td>
<td align="center" width="200">📋<br/><b>Notion</b><br/><sub>organização acadêmica</sub></td>
</tr>
<tr>
<td align="center" width="200">🐙<br/><b>Git/GitHub</b><br/><sub>controle de versão</sub></td>
<td align="center" width="200">🐍<br/><b>Django ORM</b><br/><sub>auditabilidade de dados</sub></td>
<td align="center" width="200">💻<br/><b>VS Code</b><br/><sub>ambiente de dev</sub></td>
<td align="center" width="200">🧠<br/><b>Lógica pura</b><br/><sub>listas & dicts</sub></td>
</tr>
</table>
...
```
> tipo: sistema de logística (terminal)
> stack: python puro
> destaques: atribuição automática de
...
### 🗳️ Urna Eletrônica Criptografada
```
> tipo: sistema de votação
> stack: python + mysql
> destaques: criptografia Hill Cipher
...
### 📦 Sistema de Estoque (Django)
```
> tipo: gestão de estoque/inventário
> stack: django + orm
...
### 🧭 Operação Turno Crítico (APPC)
```
> tipo: simulador de logística
> stack: python (listas & dicionários)
...
<img src="https://github-profile-trophy.vercel.app/?username=duzinetti&theme=darkhub&no-frame=true&no-bg=true&margin-w=8&column=7" />
...
<!-- ===================== SNAKE ANIMATION ===================== -->
## `07.` CONTRIBUTION_GRID

<div align="center">

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/duzinetti/duzinetti/output/github-contribution-grid-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/duzinetti/duzinetti/output/github-contribution-grid-snake.svg" />
  <img alt="snake animation" src="https://raw.githubusercontent.com/duzinetti/duzinetti/output/github-contribution-grid-snake-dark.svg" />
</picture>

<sub>⚙️ para ativar: crie o repositório <code>duzinetti/duzinetti</code> (repo de perfil) e configure a
<a href="https://github.com/Platane/snk">GitHub Action "snk"</a> — ela gera o SVG acima automaticamente a cada contribuição.</sub>
